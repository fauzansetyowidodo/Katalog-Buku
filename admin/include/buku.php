            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
				  ...
				  <a href="index.php?include=tambah-buku" class="btn btn-sm btn-info float-right"><i class="fas fa-plus"></i> Tambah Buku</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
				...
				<?php
					...
					?>
                      <tr>
                        ...
                        <td align="center">
                        <a href="index.php?include=edit-buku&data=<?php echo $id_buku;?>" class="btn btn-xs btn-info"><i class="fas fa-edit"></i> Edit</a>
                        <a href="index.php?include=detail-buku&id=<?php echo $id_buku; ?>" class="btn btn-xs btn-success" title="Detail"><i class="fas fa-eye"></i>Detail</a>
                         <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $judul; ?>?')) window.location.href = 'index.php?include=buku&aksi=hapus&data=<?php echo $id_buku;?>¬if=hapusberhasil'" class="btn btn-xs btn-warning"><i class="fas fa-trash"></i> Hapus</a>
              ...
              <div class="card-footer clearfix">
				...
				$sql_jum = "select `id_buku`,`id_kategori_buku`,`judul`,`pengarang`,`id_penerbit`,`tahun_terbit`,`sinopsis`,`cover` from `buku` ";
				if (!empty($katakunci_kategori)){
