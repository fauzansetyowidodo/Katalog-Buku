...
if((isset($_GET['aksi']))&&(isset($_GET['data']))){
	if($_GET['aksi']=='hapus'){
		$id_blog = $_GET['data'];
		//hapus data blog
		$sql_dl = "DELETE FROM `blog` WHERE `id_blog`='$id_blog'";
		mysqli_query($koneksi,$sql_dl);
	}
}
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  ...
                  <a href="index.php?include=tambah-blog" class="btn btn-sm btn-info float-right"><i class="fas fa-plus"></i> Tambah Blog</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              ...
              <table class="table table-bordered">
					...
					$sql_b = "SELECT `b`.`id_blog`, `kb`.`kategori_blog`, `b`.`judul`, `b`.`tanggal` 
                    FROM `blog` `b` 
                    INNER JOIN `kategori_blog` `kb` ON `b`.`id_kategori_blog`=`kb`.`id_kategori_blog`";
					...
					?>
                      <tr>
                        ...
                        <td align="center">
                          ...
                          <a href="index.php?include=detail-blog&id=<?php echo $id_blog; ?>" class="btn btn-xs btn-success" title="Detail"><i class="fas fa-eye"></i>Detail</a>
                          <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $id_blog; ?>?')) window.location.href = 'index.php?include=blog&aksi=hapus&data=<?php echo $id_blog;?>¬if=hapusberhasil'" class="btn btn-xs btn-warning"><i class="fas fa-trash"></i> Hapus</a>
