                  ...
                  <div class="col-sm-12">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        ?>
                        <tr>
                          <td align="center"><?php echo $posisi+1; ?></td>
                          <td><?php echo $judul; ?></td>
                          <td><?php echo $isi; ?></td>
                          <td align="center"><?php echo $tanggal; ?></td>
                          <td align="center">
                            <a href="index.php?include=detail-konten&id=<?php echo $id_konten; ?>" class="btn btn-xs btn-success" title="Detail"><i class="fas fa-eye"></i>Detail</a>
